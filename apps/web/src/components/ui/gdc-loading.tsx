...
export function GdcLoading() {
  return (
    <div className="flex items-end gap-1" role="status" aria-label="Carregando">
      {letras.map((letra, i) => (
        <span
          key={letra}
          className="inline-block text-6xl font-extrabold leading-none tracking-tight text-primary [animation:gdc-escadinha_1.2s_ease-in-out_infinite]"
